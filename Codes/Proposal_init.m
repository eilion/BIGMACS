...
if isempty(WWB) == 1
    ...
    if size(WWB,1) == 1
        ...
        index = (VV_C<data.lower_sedrate)|(VV_C>data.upper_sedrate);
        MargLik_C(index) = -inf;
        
        index = (VV_M<data.lower_sedrate)|(VV_M>data.upper_sedrate);
        MargLik_M(index) = -inf;
        
        index = (VV_E<data.lower_sedrate)|(VV_E>data.upper_sedrate);
        MargLik_E(index) = -inf;
